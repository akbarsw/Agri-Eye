      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <div className="mt-7 rounded-[2rem] border border-[#E8DDC7] bg-white/75 p-5 shadow-sm backdrop-blur">
            ...
            <div className="grid gap-5">
              {steps.map((step, index) => {
                ...
                return (
                  <article
                    key={step.title}
                    className="agri-process-card group relative overflow-hidden rounded-[2rem] border border-[#E8DDC7] bg-white/80 p-6 shadow-sm backdrop-blur transition-all duration-300 ease-in-out hover:-translate-y-1 hover:bg-white hover:shadow-md"
                  >
