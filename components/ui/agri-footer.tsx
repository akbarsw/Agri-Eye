...
function FooterLink({ href, children }: { href: string; children: string }) {
  return (
    <a
      href={href}
      className="w-fit text-sm font-medium text-[#5F584B] underline decoration-[#BEB39D] underline-offset-4 transition-colors duration-200 hover:text-[#25B866]"
    >
      {children}
    </a>
  );
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-6 md:grid-cols-[0.9fr_1.1fr] lg:grid-cols-[0.95fr_2.05fr] lg:gap-10">
          ...
          <div className="grid gap-6 sm:grid-cols-3 lg:ml-auto lg:w-[82%] lg:justify-items-start lg:gap-7">
            ...
            <div>
              <h3 className="text-sm font-bold text-[#4E473B]">Solusi</h3>
              <p className="mt-3 text-[11px] font-bold uppercase tracking-wide text-[#5F584B]">
              ...
              <p className="mt-4 text-[11px] font-bold uppercase tracking-wide text-[#5F584B]">
            ...
            <div>
              <h3 className="text-sm font-bold text-[#4E473B]">Perusahaan</h3>
              <div className="mt-3 grid gap-2.5">
                {company.map((item) => (
                  <FooterLink key={item.label} href={item.href}>{item.label}</FooterLink>
                ))}
              ...
              <div className="mt-4 grid gap-2.5 text-sm font-medium text-[#5F584B]">
                <a href="mailto:hello@agri-eye.id" className="flex items-center gap-2.5 transition-colors hover:text-[#25B866]">
                  <Mail className="h-4 w-4" />
                  hello@agri-eye.id
                </a>
                <a href="https://wa.me/6281234567890" className="flex items-center gap-2.5 transition-colors hover:text-[#25B866]">
        ...
        <div className="mt-7 border-t border-[#DCD0B8] pt-5">
